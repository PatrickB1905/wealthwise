...
import * as useInstrumentSearchModule from '@features/market-data/hooks/useInstrumentSearch';
...
const mockedUseInstrumentSearch =
  useInstrumentSearchModule.useInstrumentSearch as jest.MockedFunction<
    typeof useInstrumentSearchModule.useInstrumentSearch
  >;
...
describe('InstrumentAutocomplete', () => {
  beforeEach(() => {
    ...
    mockedUseInstrumentSearch.mockReturnValue({
      data: [tesla, amazon],
      isFetching: false,
    } as ReturnType<typeof useInstrumentSearchModule.useInstrumentSearch>);
  });
